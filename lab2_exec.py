...
def main():
    ...
    print("Hanoi Tower Game Start \n")

    while(not input_done):
        input_string = raw_input("Enter the start point <Either 1, 2, 3 or 0 to quit>")
        print("Start Point" + input_string + "\n")
    ...
    while(not input_done):
        input_string = raw_input("Enter the end point <Either 1, 2, 3 or 0 to quit>")
        print("End Point" + input_string + "\n")
        if input_string != start_point:
            if(int(input_string) == 1):
                input_done = 1
                end_point = 1
            elif (int(input_string) == 2):
                ...
                print("Please just enter the character 1 2 3 or 0 to quit \n\n")
        elif input_string == start_point:
            print("Please enter the character different from" + start_point + "in 1 2 3, or 0 to quit \n\n")
            sys.exit()
    ...
    move_block(pub_command, loop_rate, a, 0, c, 2)
    move_block(pub_command, loop_rate, a, 1, b, 2)
    move_block(pub_command, loop_rate, c, 2, b, 1)
    move_block(pub_command, loop_rate, a, 2, c, 2)
    move_block(pub_command, loop_rate, b, 1, a, 2)
    move_block(pub_command, loop_rate, b, 2, c, 1)
    move_block(pub_command, loop_rate, a, 2, c, 0)
    move_arm(pub_command, loop_rate, home, 4.0, 4.0)
    
    print("Hanoi Tower Game End")
